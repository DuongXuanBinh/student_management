...
@section('content')
    ...
    <div class="modal fade" id="delete-department" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/department/delete-department" method="get">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
    ...
    <div class="modal fade" id="delete-subject" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/department/delete-subject" method="get">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <input type="hidden" name="id">
    ...
    <div class="modal fade" id="add-subject" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                {{Form::open(['method'=>'get','url'=>'department/add-subject'])}}
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="col-md-12">
                <a data-toggle="modal" href="#add-department" class="add-department">
                ...
                <table class="table-display table-department">
                    ...
                    @foreach($departments as $department)
                        <tr>
                            ...
                            <td>
                                <a data-toggle="modal" href="#edit-department" class="update-department">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <div class="col-md-6">
            <div class="col-md-12">
                <a data-toggle="modal" href="#add-subject" class="add-subject">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                         class="bi bi-plus-square" viewBox="0 0 16 16">
                        <path
                            d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                ...
                <table class="table-subject table-display">
                    ...
                    @foreach($subjects as $subject)
                        <tr>
                            ...
                            <td>
                                <a data-toggle="modal" href="#edit-subject" class="update-subject">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                         class="bi bi-pencil" viewBox="0 0 16 16">
                                        <path
                                            d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
