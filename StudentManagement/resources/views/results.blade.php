...
@section('content')
    ...
    <div class="modal fade" id="massive-update" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                {{Form::open(['method'=>'get','url'=>'result/massive-update'])}}
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-2">
                                {{Form::label('student_id','StudentID')}}
                            </div>
                            <div class="col-md-6">
                                {{Form::text('student_id')}}
                            </div>
                            <div class="col-md-4">
                                {{Form::button('+ Add Subject',['class'=>'add-button'])}}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    {{Form::button('Cancel',['class'=>'btn btn-secondary','data-dismiss'=>'modal'])}}
                    {{Form::button('Update',['class'=>'btn btn-primary','type'=>'method'])}}
                </div>
                <{{Form::close()}}
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a data-toggle="modal" class="massive-update" href="#massive-update">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
